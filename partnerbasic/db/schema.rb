...
ActiveRecord::Schema.define(version: 20180418231058) do
  ...
  create_table "group_to_students", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_group_to_students_on_student_id"
  end
  ...
  create_table "student_to_clubs", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_student_to_clubs_on_student_id"
  end
